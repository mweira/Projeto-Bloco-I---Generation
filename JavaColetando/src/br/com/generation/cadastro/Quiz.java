...
public class Quiz {
	...
	public void escolhaOpcao()
	{
		...
		case 2:
			...
			System.out.println("========================================================================================================================================================================");
			System.out.println("Obrigade por utilizar o nosso programa. Juntos faremos um mundo melhor!");
			System.out.println();
         ...
         while(controle) {
          ...
          while(controle) {
		    ...
		    System.out.println("====================================================================================================================================");
  			...
  			System.out.println("[3] MADEIRA/METAL/PAPEL/PL�STICO/LIXO RADIOTIVO/RESIDUOS PERIGOSOS");
